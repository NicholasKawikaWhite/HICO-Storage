  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <p>For More Information or to Rent, Call <a href="tel:8088962272">808-896-2272</a></p>
        ...
        <div className={styles.grid}>
          ...
          <a href="" className={styles.card}>
            <h2>Insulated Storage</h2><p>$600 per month</p>
            <Image src="/storage.webp" alt="fruita Storage insulated storage" width={550} height={300}/>
            <div className="centered">
            <p>Units Available: {10}</p>
            </div>
          </a>
